...
export default function Welcome() {
  ...
  const handleLogin = async () => {
    try {
      await authLogin.mutateAsync({ login, password });
    } catch (error: any) {
      toast({
        variant: "destructive",
        title: "Kirishda xatolik",
        description: error.message || "Login yoki parol xato",
      });
    }
  };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-background">
      ...
      >
        ...
        <div className="glass-card p-5 rounded-2xl border border-white/10 mb-6 text-left">
          <h2 className="text-base font-semibold mb-4">Kirish</h2>
          <div className="space-y-3">
            ...
            >
              ...
              {authLogin.isPending ? "Kirilmoqda..." : "Kirish"}
            </Button>
          </div>
        </div>
